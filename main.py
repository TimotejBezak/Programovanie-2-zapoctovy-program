...
obrazok_skibidi = pygame.image.load("divne zviera.png").convert_alpha()
komponenty = generuj(obrazok_skibidi, POCET_DIELIKOV_NA_SIRKU_OBRAZKA, POCET_DIELIKOV_NA_SIRKU_OBRAZKA)
...
while running:
    ...
    if pygame.mouse.get_pos()[1] > VYSKA_ZACIATKU_SUFLIKU:
    ...
    zobrazovane_veci = sorted(zobrazovane_veci, key=lambda x: x[2])
